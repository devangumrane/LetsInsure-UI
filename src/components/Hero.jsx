    ...
    <section className="w-full bg-[#FAFAFA] pt-10 pb-20 overflow-hidden relative min-h-[500px]">
      <MaxWidthWrapper className="relative z-10">
        ...
        <div className="mt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <label htmlFor="terms" className="text-sm text-gray-600">
              ...
              <a
                href="#"
                className="font-bold text-gray-800 underline decoration-gray-400 underline-offset-2"
              >
                Terms & Conditions
              </a>
            </label>
        ...
        <div className="mt-4 text-sm text-gray-400 flex items-center gap-1">
          <span className="w-3 h-3 rounded-full border border-gray-400 flex items-center justify-center text-[8px]">
            i
          </span>
